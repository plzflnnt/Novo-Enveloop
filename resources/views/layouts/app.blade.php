        ...
        <nav class="bg-white shadow-sm border-b border-gray-200">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div class="flex justify-between h-16">
                    ...
                    <!-- Hamburger + Responsive Menu (shared Alpine scope) -->
                    <div class="sm:hidden relative" x-data="{ open: false }">
                        <div class="flex items-center">
                            <button
                                @click="open = !open"
                                :aria-expanded="open"
                                class="w-10 h-10 p-4 inline-flex items-center justify-center rounded-md text-gray-600 hover:text-gray-800 hover:bg-gray-100 focus:outline-none"
                            >
                                <i class="fas fa-bars text-lg" x-show="!open" x-cloak></i>
                        ...
                        <div
                            class="absolute left-0 right-0 top-full mt-2 bg-white rounded-md shadow-lg py-3 ring-1 ring-black ring-opacity-5 z-50"
                            x-show="open"
                            x-cloak
                        ...
                        >
                            ...
                            <div class="px-4 pt-4 pb-3 border-t border-gray-200">
                                ...
                                <div class="mt-3 space-y-1">
                                    <a href="{{ route('profile.edit') }}" class="block px-4 py-2 text-base font-medium text-gray-700 hover:text-gray-800 hover:bg-gray-50 rounded">
                                        Perfil
                                    </a>
                                    <form method="POST" action="{{ route('logout') }}">
                                        @csrf
                                        <button type="submit" class="w-full text-left block px-4 py-2 text-base font-medium text-gray-700 hover:text-gray-800 hover:bg-gray-50 rounded">
                                            Sair
                                        </button>
                                    </form>
                                </div>
